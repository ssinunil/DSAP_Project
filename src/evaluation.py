...
def plot_predictions(y_test, predictions, ticker_name):
    """
...
def plot_prediction_errors(y_test, predictions, ticker_name):
    """
...
def plot_actual_vs_predicted_scatter(y_test, predictions):
    """
